...
import { AvailableThemesEnum, DEFAULT_NON_SYSTEM_THEME, TTheme } from "@/lib/constants";
...
function ThemeMenuItem() {
  ...
  // all that was ever doing the work.
    ...
    <header className="bg-background border-b flex py-0.5 items-center sticky top-0 z-50">
      <div className="max-w-5xl mx-auto px-5 w-full flex items-center justify-between gap-4">
        <div className="flex items-center gap-4 min-w-0 flex-1">
          ...
          >
            <Logo className="size-6 group-active/link:rotate-15 transition-transform" />
          </LinkButton>
